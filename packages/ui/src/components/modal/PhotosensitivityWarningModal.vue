...
const messages = defineMessages({
	...
	body1: {
		...
		defaultMessage:
			'We cannot guarantee that all content on FreePlay has been labeled appropriately.',
	},
	body2: {
		id: 'search.photosensitivity-warning-modal.body.2',
		defaultMessage:
			'Content labels for photosensitivity triggers are self-assigned by the creators who upload their content to FreePlay. These projects have not gone through any safety testing.',
	},
	body3: {
		id: 'search.photosensitivity-warning-modal.body.3',
		defaultMessage: 'Using any content on FreePlay is at your own risk. Please stay safe! 💚',
	},
	dontShowAgain: {
