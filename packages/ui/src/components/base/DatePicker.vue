...
import { CalendarIcon, XIcon } from '@freeplay/assets'
import chevronLeftIcon from '@freeplay/assets/icons/chevron-left.svg?raw'
import chevronRightIcon from '@freeplay/assets/icons/chevron-right.svg?raw'
