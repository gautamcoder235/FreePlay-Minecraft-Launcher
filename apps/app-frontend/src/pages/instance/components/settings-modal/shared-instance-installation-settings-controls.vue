...
import { SpinnerIcon, UnlinkIcon, XIcon } from '@freeplay/assets'
import {
	Admonition,
	Button,
	commonMessages,
...
const messages = defineMessages({
	...
	unpublishDescription: {
		...
		defaultMessage:
			'Remove this shared instance from FreePlay and stop sending updates to anyone using it. Your local instance will not be affected.',
	},
	unlinkButton: {
	...
	unpublishModalBody: {
		...
		defaultMessage:
			"This deletes the shared instance from FreePlay's servers. People using it in the FreePlay Launcher will stop receiving updates, but your local instance and its content will stay on this device.",
	},
	unlinkModalHeader: {
