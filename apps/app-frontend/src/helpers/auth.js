...
/**
 * Creates an offline account with custom player nickname (SKlauncher/TLauncher style)
 * @param {string} username
 */
export async function create_offline_account(username) {
	return await invoke('plugin:auth|create_offline_account', { username })
}
