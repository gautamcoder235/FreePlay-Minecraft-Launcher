			...
			<div class="markdown-body">
				...
				<template v-if="errorType === 'directory_move'">
					<template v-if="metadata.readOnly">
						...
						<p>
							It looks like the FreePlay Launcher is unable to write to the directory you selected.
				...
				<template v-else-if="errorType === 'state_init'">
					<p>
						FreePlay Launcher failed to load correctly. This may be because of a corrupted file, or
				...
				<template v-else-if="errorType === 'no_loader_version'">
					<p>The FreePlay Launcher failed to find the loader version for this instance.</p>
