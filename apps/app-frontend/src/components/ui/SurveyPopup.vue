...
import { NotepadTextIcon, XIcon } from '@freeplay/assets'
import { Button, defineMessages, injectNotificationManager, useVIntl } from '@freeplay/ui'
...
const messages = defineMessages({
	surveyTitle: {
		id: 'app.survey.title',
		defaultMessage: 'Hey there FreePlay user!',
	},
	surveyBody: {
		id: 'app.survey.body',
		defaultMessage:
			'Would you mind answering a few questions about your experience with FreePlay Launcher?',
	},
	surveyFooter: {
		id: 'app.survey.footer',
		defaultMessage:
			'This feedback will go directly to the FreePlay team and help guide future updates!',
	},
	takeSurvey: {
...
async function processPendingSurveys() {
	...
	let surveys: Survey[] = []
	try {
		surveys = await $fetch('https://api.freeplay.app/v2/surveys')
	} catch (e) {
