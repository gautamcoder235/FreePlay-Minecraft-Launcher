...
import { MailIcon, SearchIcon, SendIcon, UserIcon, UserPlusIcon, XIcon } from '@freeplay/assets'
import {
	Avatar,
	Button,
	defineMessages,
...
const messages = defineMessages({
	...
	signInToAddFriends: {
		...
		defaultMessage:
			"<link>Sign in to a FreePlay account</link> to add friends and see what they're playing!",
	},
	addFriendsToShare: {
