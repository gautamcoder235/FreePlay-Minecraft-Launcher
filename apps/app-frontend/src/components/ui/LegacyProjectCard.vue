<script setup>
import { DownloadIcon, HeartIcon, TagIcon } from '@freeplay/assets'
import { Avatar, FormattedTag, TagItem, useCompactNumber } from '@freeplay/ui'
		...
		<div
			...
			:style="{
				...
				'background-image': `url(${
					...
					project.gallery[0] ??
					'https://launcher-files.freeplay.app/assets/maze-bg.png'
				})`,
			}"
		>
			<div
