...
function openSupport() {
	openUrl('https://support.freeplay.app')
}

const messages = defineMessages({
	header: {
		id: 'modal.freeplay-account-required.header',
		defaultMessage: 'Account required',
	},
	signingInHeader: {
		id: 'modal.freeplay-account-required.signing-in-header',
		defaultMessage: 'Signing in',
	},
	signInHeading: {
		id: 'modal.freeplay-account-required.sign-in-heading',
		defaultMessage: 'Sign in to a FreePlay account',
	},
	description: {
		id: 'modal.freeplay-account-required.description',
		defaultMessage:
			"You'll need to sign into your FreePlay account before you can use this feature.",
	},
	createAccountButton: {
		id: 'modal.freeplay-account-required.create-account-button',
		defaultMessage: 'Create an account',
	},
	signInButton: {
		id: 'modal.freeplay-account-required.sign-in-button',
		defaultMessage: 'Sign in to FreePlay',
	},
	continueInBrowserHeading: {
		id: 'modal.freeplay-account-required.continue-in-browser-heading',
		defaultMessage: 'Continue in your browser',
	},
	browserDescription: {
		id: 'modal.freeplay-account-required.browser-description',
		defaultMessage:
			'A new tab opened to sign in. Complete the sign in there, then return to the app.',
	},
	waitingForBrowser: {
		id: 'modal.freeplay-account-required.waiting-for-browser',
		defaultMessage: 'Waiting for browser confirmation...',
	},
	openBrowserAgainButton: {
		id: 'modal.freeplay-account-required.open-browser-again-button',
		defaultMessage: 'Open browser again',
	},
	supportPrompt: {
		id: 'modal.freeplay-account-required.support-prompt',
