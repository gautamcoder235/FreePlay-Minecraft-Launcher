...
export type OnboardingChecklist = { has_created_instance: boolean, has_logged_into_minecraft: boolean, has_logged_into_freeplay: boolean, show_checklist: boolean }
